...
function Get-EntraServicePrincipal {
    ...
    process {
        ...
        try {
            ...
            # The 'eq' operator is for exact match, 'like' for wildcard matching
...
function Initialization {
    ...
    process {
        ...
        try {
            ...
            Connect-MicrosoftEntra -TenantId $tenantId -ApplicationId $applicationId -ClientSecret $clientSecret -ErrorAction Stop
        ...
        Disconnect-MicrosoftEntra -Confirm:$false
